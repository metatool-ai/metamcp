...
<AccordionGroup>
  ...
  <Accordion icon="globe" title="Streamable HTTP Servers">
    **HTTP-based streaming** - Streamable HTTP is now the standard for remote MCP
    ...
    Example with an OAuth-enabled Xquik server:
    ...
    Open the server details page to connect and complete OAuth.
    MetaMCP follows Xquik's OAuth discovery and dynamic registration.
    See the [Xquik MCP guide](https://docs.xquik.com/mcp/overview).
